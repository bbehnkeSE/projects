...
int main () {
    ...
    
    {
      //------------------------------------------------------
      // Setup fixture
      bigint left("99999999999999999999999999923456141521656434246841848149840949049846846");
      bigint right(0);
      bigint result;
      ...
      // Verify
      assert(left   == "99999999999999999999999999923456141521656434246841848149840949049846846");
      assert(right  == 0);
      assert(result == 0);
    }

    {
      ...
      assert(left   == "99999999999999999999999999923456141521656434246841848149840949049846846");
      assert(right  == 1);
      assert(result == "99999999999999999999999999923456141521656434246841848149840949049846846");
    }
    
    {
      ...
      // Setup fixture
      bigint left(10);
      bigint right("9999999999999999999");
      bigint result;
      ...
      // Verify
      assert(left   == 10);
      assert(right  == "9999999999999999999");
      assert(result == "99999999999999999990");
    }
    
    {
      ...
      // Setup fixture
      bigint left(20);
      bigint right("44444444444444444444");
      bigint result;
      ...
      // Verify
      assert(left   == 20);
      assert(right  == "44444444444444444444");
      assert(result == "888888888888888888880");
    }
